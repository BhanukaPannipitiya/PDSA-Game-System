    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.logo}>
          ...
          <h1 style={styles.title}>
            ALGO<span style={styles.titleHighlight}>VERSE</span>
          </h1>
        </div>
      ...
      <div style={styles.grid}>
        {games.map((game) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow:
                  hoveredCard === game.id
                    ? `0 25px 50px ${
                        game.color.split("0%, ")[1].split("100%")[0]
                      }40`
              ...
              onClick={(e) => {
                ...
                if (isQueens && onGameSelect) {
                  onGameSelect("queens");
                } else if (isTraffic && onGameSelect) {
            ...
            >
              <div style={styles.cardBadge}>{game.status}</div>
                    ...
                    {Array.from({ length: 3 }).map((_, i) => (
                      <span
                        ...
                        style={{
                          ...
                          opacity:
                            i < ["easy", "popular"].includes(game.status)
                              ? 1
                              : 0.3,
                        }}
                      />
      ...
      <div style={styles.footer}>
        <p style={styles.footerText}>
          © 2025 AlgoVerse • Interactive Learning Platform
        </p>
